...
| `--no-nested-repo-warnings`         | Don’t warn when a subdirectory with its own `.git`/`.svn`/`.hg` is skipped during discovery. Useful for scripted/CI invocations of a project that legitimately contains nested repositories or submodules.  |
...
| `setup-py`       | `setup.py`        | A `version="..."` keyword argument to `setup()`, at the start of a line.                                                                                                                                                                                                                                                                                                                          |
| `python-version` | `__init__.py`, `_version.py`, or `version.py` | A top-level `__version__ = "..."` assignment, at the start of a line.                                                                                                                                                                                                                                                                                                            |
